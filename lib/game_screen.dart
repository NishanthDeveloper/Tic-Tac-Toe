    ...
    setState(() {
      ...
      if(_winner != ""){
        ...
        dialogType: DialogType.success,
          ...
          title: _winner == "X" ? widget.player1 + "Won!" : _winner == "O" ? widget.player2 + "Won!" : "Is's a Tie",
          btnOkOnPress: (){
          _restartGame();
          },
        )..show();
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(_currentPlayer == "X" ? widget.player1 + "($_currentPlayer) " : widget.player2+ "($_currentPlayer)",style: TextStyle(
